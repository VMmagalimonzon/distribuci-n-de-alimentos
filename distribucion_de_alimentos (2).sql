...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-08-2025 a las 17:20:13
...
INSERT INTO `alumno` (`id_alumno`, `nombre`, `apellido`, `dni`, `curso`, `division`, `celiaco`, `diabetico`) VALUES
(2, 'agustina', 'acebeso', '71', '3ro', '6ta', 1, 0),
(3, 'agustina', 'acebeso', '121212', '3ro', '6ta', 0, 1),
(4, 'agustina', 'acebeso', '2323', '2do', '4ta', 0, 0),
(5, 'magali', 'mozon', '1', '6to', '5ta', 0, 0),
(6, 'maga', 'battagliaaaa', '1', '2do', '5ta', 0, 0);
...
INSERT INTO `usuarios` (`id_usuario`, `nombre`, `apellido`, `correo`, `contraseña`, `id_cargo`, `foto`) VALUES
(1, 'magali', 'mozon', 'maga@gmail.com', '11', 1, ''),
...
--
ALTER TABLE `alumno`
  MODIFY `id_alumno` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
